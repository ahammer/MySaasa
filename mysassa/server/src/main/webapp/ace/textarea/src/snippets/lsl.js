__ace_shadowed__.define('ace/snippets/lsl', ['require', 'exports', 'module' ], function (require, exports, module) {
...
snippet remote_data\n\
    remote_data(${1:integer event_type}, ${2:key channel}, ${3:key message_id}, ${4:string senderContactInfo}, ${5:integer idata}, ${6:string sdata})\n\
    {\n\
        $0\n\
    }\n\
