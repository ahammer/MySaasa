...
})(this), ace.define("ace/mode/javascript_worker", ["require", "exports", "module", "ace/lib/oop", "ace/worker/mirror", "ace/mode/javascript/jshint"], function (require, exports, module) {
        ...
        var r = e("underscore"), i = e("events"), s = e("../shared/vars.js"), o = e("../shared/messages.js"), u = e("./lex.js").Lexer, a = e("./reg.js"), f = e("./state.js").state, l = e("./style.js"), c = e("console-browserify"), h = function () {
            ...
            function X(e, t) {
                ...
                return W(n), n.nud = typeof t == "function" ? t : function () {
                    ...
                    if (this.id === "++" || this.id === "--")f.option.plusplus ? b("W016", this, this.id) : this.right && (!this.right.identifier || c(this.right)) && this.right.id !== "." && this.right.id !== "[" && b("W017", this);
                    return this
                }, n
            }
