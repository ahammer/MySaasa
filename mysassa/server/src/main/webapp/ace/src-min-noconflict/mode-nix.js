ace.define("ace/mode/nix", ["require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp", "ace/tokenizer", "ace/mode/nix_highlight_rules", "ace/mode/folding/cstyle"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./c_cpp").Mode, s = e("../tokenizer").Tokenizer, o = e("./nix_highlight_rules").NixHighlightRules, u = e("./folding/cstyle").FoldMode, a = function () {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        var e = "true|false", t = "with|import|if|else|then|inherit", n = "let|in|rec", r = this.createKeywordMapper({"constant.language.nix": e, "keyword.control.nix": t, "keyword.declaration.nix": n}, "identifier");
        this.$rules = {start: [
            {token: "comment", regex: /#.*$/},
            {token: "comment", regex: /\/\*/, next: "comment"},
            {token: "constant", regex: "<[^>]+>"},
            {regex: "(==|!=|<=?|>=?)", token: ["keyword.operator.comparison.nix"]},
            ...
            {token: "constant.language.escape", regex: /\$\{/, push: "start"},
