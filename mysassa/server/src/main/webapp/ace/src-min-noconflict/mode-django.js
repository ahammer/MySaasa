ace.define("ace/mode/django", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/tokenizer", "ace/mode/html_highlight_rules", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    r.inherits(f, o);
    var l = function () {
        i.call(this), this.HighlightRules = f
    };
