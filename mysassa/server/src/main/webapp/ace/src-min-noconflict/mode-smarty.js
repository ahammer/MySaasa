ace.define("ace/mode/smarty", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/tokenizer", "ace/mode/smarty_highlight_rules", "ace/mode/behaviour/html", "ace/mode/folding/html"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./html").Mode, s = e("../tokenizer").Tokenizer, o = e("./smarty_highlight_rules").SmartyHighlightRules, u = e("./behaviour/html").HtmlBehaviour, a = e("./folding/html").FoldMode, f = function () {
        i.call(this), this.HighlightRules = o, this.$behaviour = new u, this.foldingRules = new a
    };
    ...
    var r = e("../lib/oop"), i = e("./html_highlight_rules").HtmlHighlightRules, s = function () {
        ...
        var e = {start: [
            ...
            {token: "punctuation.section.embedded.begin.smarty", regex: "\\{%?", push: [
                {token: "punctuation.section.embedded.end.smarty", regex: "%?\\}", next: "pop"},
                {include: "#strings"},
                {include: "#variables"},
                {include: "#lang"},
            ...
            {token: ["punctuation.definition.comment.smarty", "comment.block.smarty"], regex: "(\\{%?)(\\*)", push: [
            ...
            {token: "support.function.variable-modifier.smarty", regex: "\\|(?:capitalize|cat|count_characters|count_paragraphs|count_sentences|count_words|date_format|default|escape|indent|lower|nl2br|regex_replace|replace|spacify|string_format|strip_tags|strip|truncate|upper|wordwrap)"}
        ], "#strings": [
        ...
        ["start", "qqstring_inner", "qstring_inner", "attributes", "cdata"].forEach(function (e) {
            this.$rules[e].unshift.apply(this.$rules[e], t)
        }, this), Object.keys(e).forEach(function (t) {
            this.$rules[t] || (this.$rules[t] = e[t])
        }, this), this.normalizeRules()
    };
    s.metaData = {fileTypes: ["tpl"], foldingStartMarker: "\\{%?", foldingStopMarker: "%?\\}", name: "Smarty", scopeName: "text.html.smarty"}, r.inherits(s, i), t.SmartyHighlightRules = s
