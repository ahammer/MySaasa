ace.define("ace/mode/luapage", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/lua", "ace/tokenizer", "ace/mode/luapage_highlight_rules"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./html").Mode, s = e("./lua").Mode, o = e("../tokenizer").Tokenizer, u = e("./luapage_highlight_rules").LuaPageHighlightRules, a = function () {
        this.HighlightRules = u, this.HighlightRules = u, this.createModeDelegates({"lua-": s})
    };
...
}), ace.define("ace/mode/lua", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/lua_highlight_rules", "ace/mode/folding/lua", "ace/range", "ace/worker/worker_client"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("../tokenizer").Tokenizer, o = e("./lua_highlight_rules").LuaHighlightRules, u = e("./folding/lua").FoldMode, a = e("../range").Range, f = e("../worker/worker_client").WorkerClient, l = function () {
    ...
    r.inherits(l, i), function () {
        ...
        this.getNextLineIndent = function (e, t, r) {
            ...
            var i = t.getLine(r - 1), s = this.$getIndent(i).length, o = this.getTokenizer().getLineTokens(i, "start").tokens, u = t.getTabString().length, f = s + u * n(o), l = this.$getIndent(t.getLine(r)).length;
            if (l < f)return;
            t.outdentRows(new a(r, 0, r + 2, 0))
        }, this.createWorker = function (e) {
            var t = new f(["ace"], "ace/mode/lua_worker", "Worker");
