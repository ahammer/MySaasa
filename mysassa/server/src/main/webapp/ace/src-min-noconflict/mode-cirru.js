ace.define("ace/mode/cirru", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/cirru_highlight_rules", "ace/mode/folding/coffee"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("../tokenizer").Tokenizer, o = e("./cirru_highlight_rules").CirruHighlightRules, u = e("./folding/coffee").FoldMode, a = function () {
