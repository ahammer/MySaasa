...
})(this), ace.define("ace/mode/lua_worker", ["require", "exports", "module", "ace/lib/oop", "ace/worker/mirror", "ace/mode/lua/luaparse"], function (e, t, n) {
    ...
    r.inherits(o, i), function () {
        this.onUpdate = function () {
            ...
            try {
                ...
                t instanceof SyntaxError && this.sender.emit("error", {row: t.line - 1, column: t.column, text: t.message, type: "error"});
                return
            }
            this.sender.emit("ok")
        }
...
}), ace.define("ace/mode/lua/luaparse", ["require", "exports", "module"], function (e, t, n) {
    (function (e, n, r) {
        r(t)
        ...
        function s(e) {
            var t = r.apply(null, Dt.call(arguments, 1)), n, i;
            throw"undefined" != typeof e.line ? (i = e.range[0] - e.lineStart, n = new SyntaxError(r("[%1:%2] %3", e.line, i, t)), n.line = e.line, n.index = e.range[0], n.column = i) : (i = Bt - zt + 1, n = new SyntaxError(r("[%1:%2] %3", Ut, i, t)), n.index = Bt, n.line = Ut, n.column = i), n
        }
        ...
        function a() {
            ...
            var e = yt.charCodeAt(Bt), t = yt.charCodeAt(Bt + 1);
            Rt = Bt;
            if (L(e))return l();
            switch (e) {
                case 39:
        ...
        function l() {
            ...
            return e = yt.slice(Rt, Bt), O(e) ? t = Tt : "true" === e || "false" === e ? (t = Lt, e = "true" === e) : "nil" === e ? (t = At, e = null) : t = Nt, {type: t, value: e, line: Ut, lineStart: zt, range: [Rt, Bt]}
        }
        ...
        function p() {
            var e = yt.charCodeAt(Bt++), t = Bt, n = "", r;
            while (Bt < wt) {
                r = yt.charCodeAt(Bt++);
                if (e === r)break;
                if (92 === r)n += yt.slice(t, Bt - 1) + y(), t = Bt; else if (Bt >= wt || N(r))n += yt.slice(t, Bt - 1), s({}, Mt.unfinishedString, n + String.fromCharCode(r))
            }
        ...
        function d() {
            var e = w();
            return!1 === e && s(jt, Mt.expected, "[", jt.value), {type: xt, value: e, line: Ut, lineStart: zt, range: [Rt, Bt]}
        }

        function v() {
            var e = yt.charAt(Bt), t = yt.charAt(Bt + 1), n = "0" === e && "xX".indexOf(t || null) >= 0 ? m() : g();
            return{type: Ct, value: n, line: Ut, lineStart: zt, range: [Rt, Bt]}
        }

        function m() {
            var e = 0, t = 1, n = 1, r, i, o, u;
            ...
            if ("pP".indexOf(yt.charAt(Bt) || null) >= 0) {
                Bt++, "+-".indexOf(yt.charAt(Bt) || null) >= 0 && (n = "+" === yt.charAt(Bt++) ? 1 : -1), o = Bt, C(yt.charCodeAt(Bt)) || s({}, Mt.malformedNumber, yt.slice(Rt, Bt));
        ...
        function g() {
            ...
            if ("eE".indexOf(yt.charAt(Bt) || null) >= 0) {
                Bt++, "+-".indexOf(yt.charAt(Bt) || null) >= 0 && Bt++, C(yt.charCodeAt(Bt)) || s({}, Mt.malformedNumber, yt.slice(Rt, Bt));
                while (C(yt.charCodeAt(Bt)))Bt++
            }
        ...
        function b() {
            Rt = Bt, Bt += 2;
            var e = yt.charAt(Bt), t = "", n = !1, r = Bt, i = zt, s = Ut;
            "[" === e && (t = w(), !1 === t ? t = e : n = !0);
            if (!n) {
                while (Bt < wt) {
            ...
            if (bt.comments) {
                ...
                bt.locations && (o.loc = {start: {line: s, column: Rt - i}, end: {line: Ut, column: Bt - zt}}), bt.ranges && (o.range = [Rt, Bt]), qt.push(o)
            }
        }
        ...
        function R(e) {
            bt.locations && (this.loc = {start: {line: e.line, column: e.range[0] - e.lineStart}, end: {line: 0, column: 0}}), bt.ranges && (this.range = [e.range[0], 0])
        }
        ...
        function et() {
            var e = [], n, r, i;
            Jt && (i = $t[$t.length - 1], $t.push(i)), n = ft(), x("then"), r = X(), e.push(t(_t.ifClause(n, r))), Jt && (i = q());
            while (S("elseif"))z(i), n = ft(), x("then"), r = X(), e.push(t(_t.elseifClause(n, r))), Jt && (i = q());
            return S("else") && (Jt && (i = new R(Ft), $t.push(i)), r = X(), e.push(t(_t.elseClause(r)))), x("end"), t(_t.ifStatement(e))
        }
        ...
        function ut() {
            ...
            for (; ;) {
                U();
                if (kt === jt.type && S("["))n = ft(), x("]"), x("="), r = ft(), e.push(t(_t.tableKey(n, r))); else if (Nt === jt.type)n = ft(), S("=") ? (r = ft(), e.push(t(_t.tableKeyString(n, r)))) : e.push(t(_t.tableValue(n))); else {
                    if (null == (r = at())) {
                        $t.pop();
                        break
                    }
        ...
        function ht() {
            var e, n, r, i;
            Jt && (r = q());
            if (Nt === jt.type)n = jt.value, e = it(), bt.scope && F(e, i = I(n)); else {
                if (!S("("))return null;
                e = ft(), x(")"), bt.scope && (i = e.isLocal)
            }
            var s, o;
            for (; ;)if (kt === jt.type)switch (jt.value) {
                case"[":
        ...
        function dt() {
            var e = xt | Ct | Lt | At | Ot, n = jt.value, r = jt.type, i;
            Jt && (i = q());
            if (r & e) {
                z(i);
        ...
        function vt(t, n) {
            return"undefined" == typeof n && "object" == typeof t && (n = t, t = undefined), n || (n = {}), yt = t || "", bt = i(Et, n), Bt = 0, Ut = 1, zt = 0, wt = yt.length, Wt = [
                []
            ], Xt = 0, Vt = [], $t = [], bt.comments && (qt = []), bt.wait ? e : gt()
        }
        ...
        e.version = "0.1.4";
        var yt, bt, wt, Et = e.defaultOptions = {wait: !1, comments: !0, scope: !1, locations: !1, ranges: !1}, St = 1, xt = 2, Tt = 4, Nt = 8, Ct = 16, kt = 32, Lt = 64, At = 128, Ot = 256;
        e.tokenTypes = {EOF: St, StringLiteral: xt, Keyword: Tt, Identifier: Nt, NumericLiteral: Ct, Punctuator: kt, BooleanLiteral: Lt, NilLiteral: At, VarargLiteral: Ot};
        var Mt = e.errors = {unexpected: "Unexpected %1 '%2' near '%3'", expected: "'%1' expected near '%2'", expectedToken: "%1 expected near '%2'", unfinishedString: "unfinished string near '%1'", malformedNumber: "malformed number near '%1'"}, _t = e.ast = {labelStatement: function (e) {
            ...
            return e = e === xt ? "StringLiteral" : e === Ct ? "NumericLiteral" : e === Lt ? "BooleanLiteral" : e === At ? "NilLiteral" : "VarargLiteral", {type: e, value: t, raw: n}
        ...
        }}, Dt = Array.prototype.slice, Pt = Object.prototype.toString, Ht = function (e, t) {
            for (var n = 0, r = e.length; n < r; n++)if (e[n] === t)return n;
            return-1
        }, Bt, jt, Ft, It, qt, Rt, Ut, zt;
        e.lex = a;
        var Wt, Xt, Vt, $t = [], Jt;
        R.prototype.complete = function () {
            bt.locations && (this.loc.end.line = Ft.line, this.loc.end.column = Ft.range[1] - Ft.lineStart), bt.ranges && (this.range[1] = Ft.range[1])
        }, e.parse = vt, e.write = mt, e.end = gt
    })
