ace.define("ace/mode/coldfusion", ["require", "exports", "module", "ace/lib/oop", "ace/mode/xml", "ace/mode/javascript", "ace/mode/css", "ace/tokenizer", "ace/mode/coldfusion_highlight_rules", "ace/mode/behaviour/coldfusion"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./xml").Mode, s = e("./javascript").Mode, o = e("./css").Mode, u = e("../tokenizer").Tokenizer, a = e("./coldfusion_highlight_rules").ColdfusionHighlightRules, f = e("./behaviour/coldfusion").CfmlBehaviour, l = function () {
        i.call(this), this.HighlightRules = a, this.$behaviour = new f, this.createModeDelegates({"js-": s, "css-": o})
    };
    ...
    var r = e("../lib/oop"), i = e("./javascript_highlight_rules").JavaScriptHighlightRules, s = e("./html_highlight_rules").HtmlHighlightRules, o = function () {
        s.call(this), this.embedTagRules(i, "cfjs-", "cfscript"), this.normalizeRules()
    };
    ...
    r.inherits(f, i), function () {
        this.blockComment = {start: "<!--", end: "-->"}, this.$id = "ace/mode/xml"
    }.call(f.prototype), t.Mode = f
}), ace.define("ace/mode/behaviour/coldfusion", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour/xml", "ace/mode/behaviour/cstyle", "ace/token_iterator"], function (e, t, n) {
    function a(e, t) {
    ...
    var r = e("../../lib/oop"), i = e("../behaviour/xml").XmlBehaviour, s = e("./cstyle").CstyleBehaviour, o = e("../../token_iterator").TokenIterator, u = ["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"], f = function () {
        this.inherit(i), this.add("autoclosing", "insertion", function (e, t, n, r, i) {
            if (i == ">") {
                ...
                if (l && a(l, "meta.tag.name") && /^cf+(abort|application|argument|associate|break|cache|collection|cookie|dbinfo|directory|dump|else|elseif|error|exchangecalendar|exchangeconnection|exchangecontact|exchangefilter|exchangetask|exit|feed|file|flush|ftp|header|htmlhead|httpparam|image|import|include|index|insert|invokeargument|location|log|mailparam|NTauthenticate|object|objectcache|param|pdfformparam|print|procparam|procresult|property|queryparam|registry|reportparam|rethrow|return|schedule|search|set|setting|throw|zipparam)$/gi.test(l.value))return;
                if (a(l, "string") && f.getCurrentTokenColumn() + l.value.length > s.column)return;
                var c = !1;
    ...
    r.inherits(f, i), t.CfmlBehaviour = f
