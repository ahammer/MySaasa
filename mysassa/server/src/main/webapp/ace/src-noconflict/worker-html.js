...
ace.define('ace/mode/html/saxparser', ['require', 'exports', 'module' ], function (require, exports, module) {
    var req = require = (function (e, t, n) {
            function i(n, s) {
                if (!t[n]) {
                    if (!e[n]) {
            ...
            (function () {
                ...
                function TreeBuilder() {
                    ...
                    modes.text.startTagOther = function (name) {
                        throw "Tried to getEditPanel start tag " + name + " in RCDATA/RAWTEXT mode";
                    };
            ...
            exports.inspect = function (obj, showHidden, depth, colors) {
                ...
                function format(value, recurseTimes) {
                    if (value && typeof value.inspect === 'function' &&
                        value !== exports && !(value.constructor && value.constructor.prototype === value)) {
            ...
            process.nextTick = (function () {
                ...
                if (canPost) {
                    ...
                    window.addEventListener('message', function (ev) {
                        if (ev.source === window && ev.data === 'getEditPanel-tick') {
                            ev.stopPropagation();
                            if (queue.length > 0) {
                                var fn = queue.shift();
                                fn();
                    ...
                    return function nextTick(fn) {
                        queue.push(fn);
                        window.postMessage('getEditPanel-tick', '*');
                    };
                }
