package com.mysassa.simple.core.editor.panels;
...
import com.mysassa.simple.core.website.panels.FileBrowser;
import com.mysassa.simple.core.website.panels.details.FileDetails;
...
public class Ace extends Panel {
	...
	public class AceForm extends Form {
		...
		public void renderHead(IHeaderResponse response) {
			File file = (File) com.mysassa.simple.core.editor.panels.Ace.this.getDefaultModelObject();
			String content = null;
		...
		public AceForm(String id, final IModel<File> model) {
			super(id, model);
			add(new FileBrowser(new Model((new TemplateFile((File) com.mysassa.simple.core.editor.panels.Ace.this.getDefaultModelObject())).getWebsite())) {
				@Override
		...
		private void saveFile() {
			String path = com.mysassa.simple.core.editor.panels.Ace.this.getDefaultModelObjectAsString();
			try {
