...
import com.mysassa.simple.api.ApiParameter;
...
public class Function extends Panel {
	...
	private class FunctionForm extends WebMarkupContainer {
		public FunctionForm() {
			super("form", com.mysassa.simple.pages.docs.api.Function.this.getDefaultModel());

			ApiMapping mapping = (ApiMapping) com.mysassa.simple.pages.docs.api.Function.this.getDefaultModelObject();
