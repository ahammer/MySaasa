package com.mysassa.simple.core.organization.panels.manager;
...
import com.mysassa.simple.core.users.panels.ContactInfoEditor;
				...
				try {
					...
					modal.setContent(new VerifyAdmin(modal.getContentId()) {
						...
						protected void grantAccessTemporarily(AjaxRequestTarget target) {
							...
							OrganizationService.get().deleteOrganization(o);
