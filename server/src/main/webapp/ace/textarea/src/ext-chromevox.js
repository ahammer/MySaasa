__ace_shadowed__.define('ace/ext/chromevox', ['require', 'exports', 'module' , 'ace/editor', 'ace/config'], function (require, exports, module) {
    var cvoxAce = {};
...
;
(function () {
    __ace_shadowed__.require(["ace/ext/chromevox"], function () {
    });
})();
