ace.define("ace/mode/html_ruby", ["require", "exports", "module", "ace/lib/oop", "ace/tokenizer", "ace/mode/html_ruby_highlight_rules", "ace/mode/html", "ace/mode/javascript", "ace/mode/css", "ace/mode/ruby"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("../tokenizer").Tokenizer, s = e("./html_ruby_highlight_rules").HtmlRubyHighlightRules, o = e("./html").Mode, u = e("./javascript").Mode, a = e("./css").Mode, f = e("./ruby").Mode, l = function () {
        o.call(this), this.HighlightRules = s, this.createModeDelegates({"js-": u, "css-": a, "ruby-": f})
    };
    ...
    var r = e("../lib/oop"), i = e("./html_highlight_rules").HtmlHighlightRules, s = e("./ruby_highlight_rules").RubyHighlightRules, o = function () {
        i.call(this);
        var e = [
            {regex: "<%%|%%>", token: "constant.language.escape"},
            {token: "comment.start.erb", regex: "<%#", push: [
                {token: "comment.end.erb", regex: "%>", next: "pop", defaultToken: "comment"}
            ]},
