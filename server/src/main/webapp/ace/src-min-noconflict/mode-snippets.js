ace.define("ace/mode/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/folding/coffee"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("../tokenizer").Tokenizer, o = e("./text_highlight_rules").TextHighlightRules, u = function () {
        ...
        this.$rules = {start: [
            ...
            }, tokenName: "markup.list", regex: "\\${",next:"varDecl"},{onMatch:function(e,t,n){return n[1]?(n[1]--,n[1]||n.splice(0,2),this.tokenName):"text"},tokenName:"markup.list",regex:"}"},
    ...
    r.inherits(a, o), t.SnippetGroupHighlightRules = a;
    var f = e("./folding/coffee").FoldMode, l = function () {
        this.HighlightRules = a, this.foldingRules = new f
    };
    r.inherits(l, i), function () {
        this.$indentWithTabs = !0, this.$id = "ace/mode/snippets"
