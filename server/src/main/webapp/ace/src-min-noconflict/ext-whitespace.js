ace.define("ace/ext/whitespace", ["require", "exports", "module", "ace/lib/lang"], function (e, t, n) {
    ...
    t.$detectIndentation = function (e, t) {
        ...
        for (var u = 0; u < o; u++) {
            ...
            if (l && a[l] != "	") {
                var c = l - s;
                c > 0 && !(s % c) && !(l % c) && (r[c] = (r[c] || 0) + 1), n[l] = (n[l] || 0) + 1
            }
            s = l;
        ...
        var n = e.getDocument(), r = n.getAllLines(), i = t ? -1 : 0;
        for (var s = 0, o = r.length; s < o; s++) {
            var u = r[s], a = u.search(/\s+$/);
            a > i && n.removeInLine(s, a, u.length)
        }
        ...
        for (var c = 0, h = a.length; c < h; c++) {
            ...
            if (d) {
                var v = e.$getStringScreenWidth(d)[0], m = Math.floor(v / s), g = v % s, y = f[m] || (f[m] = r.stringRepeat(o, m));
                y += l[g] || (l[g] = r.stringRepeat(" ", g)), y != d && (u.removeInLine(c, 0, d.length), u.insertInLine({row: c, column: 0}, y))
            }
        }
        ...
        {name: "detectIndentation", exec: function (e) {
            t.detectIndentation(e.session)
        }},
        {name: "trimTrailingSpace", exec: function (e) {
            t.trimTrailingSpace(e.session)
        }},
        {name: "convertIndentation", exec: function (e, n) {
            var r = t.$parseArg(n);
            t.convertIndentation(e.session, r.ch, r.length)
        }},
        {name: "setIndentation", exec: function (e, n) {
            var r = t.$parseArg(n);
