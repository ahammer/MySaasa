ace.define("ace/mode/handlebars", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/tokenizer", "ace/mode/handlebars_highlight_rules", "ace/mode/behaviour/html", "ace/mode/folding/html"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./html").Mode, s = e("../tokenizer").Tokenizer, o = e("./handlebars_highlight_rules").HandlebarsHighlightRules, u = e("./behaviour/html").HtmlBehaviour, a = e("./folding/html").FoldMode, f = function () {
...
}), ace.define("ace/mode/handlebars_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules", "ace/mode/xml_util"], function (e, t, n) {
    function o(e, t) {
        return t.splice(0, 3), t.shift() || "start"
    }

    var r = e("../lib/oop"), i = e("./html_highlight_rules").HtmlHighlightRules, s = e("./xml_util"), u = function () {
        i.call(this);
        var e = {regex: "(?={{)", push: "handlebars"};
        for (var t in this.$rules)this.$rules[t].unshift(e);
        this.$rules.handlebars = [
            {token: "comment.start", regex: "{{!--", push: [
                {token: "comment.end", regex: "--}}", next: o},
                {defaultToken: "comment"}
            ]},
            {token: "comment.start", regex: "{{!", push: [
                {token: "comment.end", regex: "}}", next: o},
            ...
            {token: "storage.type.start", regex: "{{[#\\^/&]?", push: [
                {token: "storage.type.end", regex: "}}", next: o},
                {token: "variable.parameter", regex: "[a-zA-Z_$][a-zA-Z0-9_$]*"}
            ]},
            {token: "support.function", regex: "{{{", push: [
                {token: "support.function", regex: "}}}", next: o},
                {token: "variable.parameter", regex: "[a-zA-Z_$][a-zA-Z0-9_$]*"}
            ]}
        ], this.normalizeRules()
    };
    r.inherits(u, i), t.HandlebarsHighlightRules = u
