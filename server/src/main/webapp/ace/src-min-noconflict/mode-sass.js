ace.define("ace/mode/sass", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/sass_highlight_rules", "ace/mode/folding/coffee"], function (e, t, n) {
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("../tokenizer").Tokenizer, o = e("./sass_highlight_rules").SassHighlightRules, u = e("./folding/coffee").FoldMode, a = function () {
    ...
    var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./scss_highlight_rules").ScssHighlightRules, o = function () {
        ...
        e[1].token == "comment" && (e.splice(1, 1, {onMatch: function (e, t, n) {
            return n.unshift(this.next, -1, e.length - 2, t), "comment"
        }, regex: /^\s*\/\*/, next: "comment"}, {token: "error.invalid", regex: "/\\*|[{;}]"}, {token: "support.type", regex: /^\s*:[\w\-]+\s/}), this.$rules.comment = [
